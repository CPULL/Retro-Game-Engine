...
public class CodeEditor : MonoBehaviour {
  ...
  readonly Regex rgCommentMLs = new Regex("/\\*(?:(?!\\*/)(?:.|[\r\n]+))*", RegexOptions.IgnoreCase | RegexOptions.Multiline, System.TimeSpan.FromSeconds(10));
  ...
  public CodeNode CompileCode(string code, bool checkCompleteness, int startOffset = 0) {
    ...
    try {
      cp.ParseSingleBlock = !checkCompleteness;
      result = cp.Parse(code, compVariables, true, startOffset);
